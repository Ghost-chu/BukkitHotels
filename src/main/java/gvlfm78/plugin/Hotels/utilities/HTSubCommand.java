...
public class HTSubCommand {
     ...
     */
    public HTSubCommand(String permission, int minArgs, Runnable method, String... labels) {
     ...
     * @param labels Subcommand label (e.g. list) and any aliases
     */
    public HTSubCommand(boolean needsPlayer, String permission, int minArgs, Runnable method, String... labels) {
     ...
     * @param labels Subcommand label (e.g. list) and any aliases
     */
    public HTSubCommand(String subSubCommand, String permission, int minArgs, Runnable method, String... labels) {
     ...
     * @param labels Subcommand label (e.g. list) and any aliases
     */
    public HTSubCommand(String subSubCommand, boolean needsPlayer, String permission, int minArgs, Runnable method, String... labels){
    ...
    public boolean hasSubSubCommand(){
        return subSubCommand != null;
    }
    public boolean isSubSubCommand(String subSubCommand){
        if(!hasSubSubCommand() || subSubCommand == null) return false;
