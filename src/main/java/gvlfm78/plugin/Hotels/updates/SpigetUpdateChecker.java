...
public class SpigetUpdateChecker {
    ...
    private static final String USER_AGENT  = "Hotels";
    private static final String VERSIONS_URL = "https://api.spiget.org/v2/resources/2047/versions?size=15000";
    private static final String UPDATES_URL = "https://api.spiget.org/v2/resources/2047/updates?size=15000";
